...
export default function Contacts() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex space-x-1 md:space-x-2">
            <button
              ...
              className="p-2 md:px-3 md:py-2 text-xs md:text-sm font-medium text-white bg-green-600 rounded-xl hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all transform hover:scale-105"
            >
              <div className="flex items-center">
            ...
            <button
              ...
              className="p-2 md:px-3 md:py-2 text-xs md:text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all transform hover:scale-105"
            >
              <div className="flex items-center">
                <svg className="h-4 w-4 md:h-5 md:w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              className="p-2 md:px-3 md:py-2 text-xs md:text-sm font-medium text-white bg-red-600 rounded-xl hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all transform hover:scale-105"
            >
              <div className="flex items-center">
                <svg className="h-4 w-4 md:h-5 md:w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Search Bar */}
      <div className="bg-white border-b border-gray-200 shadow-sm sticky top-16 z-10 py-3">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-xl my-4">
            <div className="p-4 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">
                Semua Kontak <span className="text-gray-500">({filteredUsers.length})</span>
              </h2>
            </div>
              ...
              {filteredUsers.length > 0 ? (
                  ...
                  <li key={index}>
                    ...
                    >
                      <div className="px-4 py-3 sm:px-6">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-12 w-12 sm:h-14 sm:w-14 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center">
                ...
                <li className="px-4 py-12 text-center">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Mulai dengan tambah kontak atau tunggu seseorang chat bot kamu.
                  </p>
                </li>
              )}
            </ul>
      ...
      {error && (
        <div className="fixed bottom-20 md:bottom-4 right-4 bg-red-500 text-white px-4 py-2 rounded-xl shadow-lg animate-pulse">
          {error}
        </div>
      )}
    </div>
